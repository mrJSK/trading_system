...
class _$CompanyFinancialsImpl implements _CompanyFinancials {
  ...
  @override
  String toString() {
    return 'CompanyFinancials(quarterlyResults: $quarterlyResults, profitLossStatement: $profitLossStatement, balanceSheet: $balanceSheet, cashFlowStatement: $cashFlowStatement, ratios: $ratios, shareholdingPattern: $shareholdingPattern, growthTables: $growthTables, ratiosData: $ratiosData)';
  }
...
abstract class _CompanyFinancials implements CompanyFinancials {
  const factory _CompanyFinancials(
      ...
      final Map<String, dynamic> ratiosData}) = _$CompanyFinancialsImpl;
