...
class FundamentalAnalysisService {
  // ============================================================================
  // EXPERT-LEVEL RATIO CALCULATIONS
  // ============================================================================
  ...
  static double? calculateAssetQuality(CompanyModel company) {
    ...
    final tangibleAssets = latest.totalAssets! - (latest.totalLiabilities ?? 0);
  ...
  static Map<String, dynamic> generateBenchmarkAnalysis(
    ...
    return {
      ...
      'roe_vs_sector': company.roe != null ? (company.roe! - sectorROE) : null,
  ...
  static Map<String, dynamic> calculateValuationMetrics(CompanyModel company) {
    ...
    if (graham != null) {
      ...
      if (company.currentPrice != null) {
        final safetyMargin = ((graham - company.currentPrice!) / graham) * 100;
